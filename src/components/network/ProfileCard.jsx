...
export default function ProfileCard({ name, headline, mutuals, avatarSrc }) {
  return (
    <Card variant="outlined" sx={{width: 300, borderRadius: 3, textAlign: 'center', transition: '0.3s', '&:hover': { boxShadow: '0 4px 20px rgba(0,0,0,0.1)' } }}>
      ...
      <Box sx={{ p: 2 }}>
        ...
        <Button fullWidth sx={{ mt: 2, borderRadius: 10, border: '1px solid #00B4D8', color: '#00B4D8', fontWeight: 'bold', '&:hover': { bgcolor: '#f0fdff' } }}>
          Connect
        </Button>
      </Box>
    </Card>
