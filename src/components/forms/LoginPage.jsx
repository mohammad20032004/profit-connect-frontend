...
export default function LoginPage() {
    ...
    return (
        <Grid container sx={{ height: '100vh', width: '100%'  }} maxWidth={'xl'}>
            ...
            <Grid
                    ...
                    position: 'relative',
                    backgroundColor: '#240046',
                    backgroundImage: 'url(https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop)', // صورة خلفية شبيهة
            ...
            >
                <Box sx={{ position: 'relative', zIndex: 1, textAlign: 'center', px: 4, maxWidth: '500px' }}>
                    {/* الأيقونة الكبيرة */}
                    <SchoolIcon sx={{ fontSize: 100, mb: 2, color: '#fff' }} />
                ...
                <Box sx={{ position: 'relative', zIndex: 1, position: 'absolute', bottom: 40, left: 40, display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Typography variant="subtitle2" sx={{ letterSpacing: 2 }}>CAREERPATH</Typography>
                </Box>
            </Grid>
                ...
                <Box sx={{ width: '100%', maxWidth: { xs: '100%', md: '100%' }, p: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 4 }}>
                        <Box sx={{ bgcolor: '#240046', color: 'white', p: 0.5, borderRadius: '4px', display: 'flex' }}>
                            <Typography variant="h6" fontWeight="bold" lineHeight={1} px={0.5}>C</Typography>
                        </Box>
                        <Typography variant="h5" fontWeight="bold" color="#240046">
                            CareerPath
                        </Typography>
                    </Box>
                    ...
                    <form noValidate>
                        <Stack spacing={3}>
                            ...
                            {/* Submit Button */}
                            <PrimaryButton fullWidth variant="contained" type="submit">
                                Sign In
                            </PrimaryButton>
                        </Stack>
                    </form>
